...
- Wired in [ForceAtlas2](https://doi.org/10.1371/journal.pone.0098679)
  from [manifolds-rs](https://crates.io/crates/manifolds-rs).

## manifoldsR 0.3.2

### Features

- Parameters all wrapped via
  [devforge](https://github.com/GregorLueg/devforge).

## manifoldsR 0.3.1

### Features

- Version updates on the backend to enable avx2 and avx512 instructions
  by default.
