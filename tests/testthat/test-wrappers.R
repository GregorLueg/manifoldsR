test_that("umap works with basic inputs", {
...
test_that("umap handles data frames", {
...
test_that("umap validates inputs correctly", {
    test_data <- matrix(rnorm(100 * 5), nrow = 100, ncol = 5)
...
test_that("umap respects custom parameters", {
    test_data <- matrix(rnorm(100 * 5), nrow = 100, ncol = 5)
...
test_that("umap automatic n_epochs detection works", {
    ...
    expect_null(params_small$n_epochs)
...
test_that("tsne works with basic inputs", {
    # Generate simple test data
    set.seed(42)
    test_data <- matrix(rnorm(100 * 5), nrow = 100, ncol = 5)
...
test_that("tsne handles data frames", {
    # Test with data frame
...
test_that("tsne validates inputs correctly", {
    test_data <- matrix(rnorm(100 * 5), nrow = 100, ncol = 5)
...
test_that("tsne respects custom parameters", {
    test_data <- matrix(rnorm(100 * 5), nrow = 100, ncol = 5)
...
test_that("umap and tsne handle edge cases", {
    # Small datasetk
    small_data <- matrix(rnorm(10 * 3), nrow = 10, ncol = 3)

    expect_no_error(umap(small_data, seed = 42L))
    expect_no_error(tsne(small_data, seed = 42L))
